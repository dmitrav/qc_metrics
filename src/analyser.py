...
def plot_and_save(normal_values, spoilt_values, metrics_names, plot_title, path_to_save_to, to_show=False):
    """ This method get the values for plotting, draws the violin plot to compare distributions,
